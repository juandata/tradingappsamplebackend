...
# Trading app sample with MERN Stack
A trading app sample for buying and selling stock and cryptos. User is able to program when to buy or sell stocks, the app will executethe order when the price is reached. Profits and losses are displayed in real time.
